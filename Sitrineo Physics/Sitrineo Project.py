...
plt.figure()
plt.plot(T_Sr_spectre,spectre_Sr,'b',label='Spectrum Strontium')
plt.plot(T_Y_spectre,spectre_Y,'r',label='Spectrum Yttrium')
plt.plot(E_combined,spectre_combined1,'k',label='Spectrum Cumulated')
plt.plot(E_2,spectre_combined2,'k')
plt.xlabel('Kinetic energy (eV)')
plt.ylabel('Probability')
plt.title("Probability density associated with the kinetic energy of 100 000 beta decays emissions")
plt.legend()
