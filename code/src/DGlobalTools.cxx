...
void DGlobalTools::SetVetoPixel( int noiseRun) {
  ...
  else if ( noiseRun == 28010 ) {
    printf( "  VETO PIXELS : configuration is MIMOSA 28 - SITRINEO IPHC - run 10\n");
    VetoPixel = vetoPixel_SITRINEO_IPHC;
  }
  else if ( noiseRun == 28667 ) {
    printf( "  VETO PIXELS : configuration is MIMOSA 28 - SITRINEO IPHC\n");
    VetoPixel = vetoPixel_Mi28SitrineoIPHC;
  }
  else {
